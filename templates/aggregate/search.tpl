    ...
    {if !$results.empty}
      <nav class="nav nav-pills mt-5 pt-5 activate-first-tab">
        ...
        {if count($results.statements)}
          <a class="nav-link text-capitalize" id="statements-tab" data-bs-toggle="tab" role="tab" aria-controls="results-statements"
        ...
        {if count($results.regions)}
          <a class="nav-link text-capitalize" id="regions-tab" data-bs-toggle="tab" role="tab" aria-controls="results-regions"
        ...
        {if count($results.tags)}
          <a class="nav-link text-capitalize" id="tags-tab" data-bs-toggle="tab" role="tab" aria-controls="results-tags"
             href="#results-tags">
            {t}title-tags{/t}
          </a>
        {/if}
